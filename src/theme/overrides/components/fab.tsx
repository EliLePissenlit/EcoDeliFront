...
declare module '@mui/material/Fab' {
  interface FabPropsVariantOverrides {
    ...
    soft: true;
    softExtended: true;
    gradient: true; // Ajout du variant "gradient" pour les Fab
  }
}
...
export function fab(theme: Theme) {
  ...
  const rootStyles = (ownerState: FabProps) => {
    const gradientVariant = ownerState.variant === 'gradient'; // Vérifier si le variant est "gradient"
    ...
    const defaultStyle = {
      ...
      // GRADIENT (Nouveau variant ajouté)
      ...(gradientVariant && {
